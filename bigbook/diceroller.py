...
dice, followed by "d", followed by the number of sides the dice has.
You can also add a plus or minus adjustment.

Examples:
    3d6 rolls 6-sided dice thrice
    1d10+2 rolls one 10-sided dice, and add 2
    2d38-1 rolls 38-sided dice, and subtracts 1
