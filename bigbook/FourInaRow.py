...
# Note: Update displayBoard() and COLUMN_LABELS if BOARD_WIDTH is changed.
BOARD_WIDTH = 7
BOARD_HEIGHT = 6
...
Two players take turns dropping tiles into one of the seven columns, trying
...
def askForPlayerMove(playerTile, board):
    ...
    while True:  # Keep asking the player until they enter a valid move.
        print(f'Player {playerTile}, enter a column or QUIT:')
