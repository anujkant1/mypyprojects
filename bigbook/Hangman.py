...
# A version of this game is featured in book "Invent Your Own
...
def main():
    ...
    secretWord = random.choice(WORDS)  # The word that player must guess.
...
# If this program is run instead of imported, run the program.
