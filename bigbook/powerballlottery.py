...
while True:
    ...
    print('each number. (For example: 5 17 23 82 40)')
    response = input('> ')
    ...
    try:
        ...
        print('Please enter numbers, like 26, 98, or 21.')
        continue
...
while True:
    ...
    try:
        ...
        print('Please enter a number, like 26, 5, or 21.')
        continue
...
while True:
    ...
    try:
        ...
        print('Please enter a number, like 26, 98, or 21.')
        continue
