...
This problem does a Monte Carlo simulation (that is, repeated random
simulations) to explore this concept.

(It's not actually a paradox, it's a surprising result.)
''')
...
# Generate and dispaly the birthdays:
...
simMatch = 0  # How many simulations and matching birthdays in them.
