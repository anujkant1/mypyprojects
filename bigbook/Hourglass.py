...
def runHourglassSimulation(allSand):
    ...
    while True:  # Keep looping until sand has run out.
        ...
        for i, sand in enumerate(allSand):
            ...
            # If nothing is under the sand, move it down:
            ...
            if canFallDown:
                ...
                bext.goto(sand[X], sand[Y])
                print(" ", end="")  # Clear the old postion.
                ...
                canFallLeft = (
                    noSandBelowLeft and noWallBelowLeft and noWallLeft and notOnLeftEdge
                )
