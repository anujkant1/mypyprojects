...
This game will ask children to add two numbers and then check if it's correct.
...
def check_funny_answer(num1, num2, child_response):
    if str(num1) + str(num2) == child_response:
        ...
        return f"Sorry, the expected funny answer was {num1}{num2} so your funny answer {child_response} is not correct!"
...
def main():
    while True:
        try:
            ...
            print("You have not provided a valid number.")
